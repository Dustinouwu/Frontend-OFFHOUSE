    ...
    return (
        <div>
            ...
            <Modal
                ...
                onClose={handleClose}
            >
                <Box sx={{ '& .MuiTextField-root': { ml: 0, mb: 2, width: '47ch' }, gap: '2%', ...style, width: 400, pr: 15,[`@media (max-width: 600px)`]: { width: 300 }, [`@media (max-width: 500px)`]: { width: 200, '& .MuiTextField-root': { ml: 0, mb: 2, width: '30ch' } } }}>
